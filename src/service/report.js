...
//按机器统计
export const machineReportFun = payload =>
  fetch.post(machineReportApi, payload);
...
//流水明细
export const balanceLogFlowListFun = payload =>
  fetch.post(balanceLogFlowListApi, payload);
