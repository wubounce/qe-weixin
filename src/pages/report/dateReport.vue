...
export default {
  ...
  data () {
    return {
      ...
      /* eslint-disable */
      searchData: {
        time: [moment().startOf('month').format("YYYY-MM-DD"), moment().format("YYYY-MM-DD")],
        shopIds: [],
      },
    }
  },
  ...
  methods: {
    ...
    resetForm (formName) {
      ...
      /* eslint-disable */
      this.searchData.time = [moment().startOf('month').format("YYYY-MM-DD"), moment().format("YYYY-MM-DD")]
