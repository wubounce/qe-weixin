  ...
  data() {
    return {
      ...
      addGoldDynamicFormRules: {
        ...
        discountProportion: [{ required: true, message: '请填写抵扣比例', trigger: 'blur' }, { pattern: /^(([1-9]|[1-9][0-8]?)(\.\d{0,1})?|(([1-8][0-9]?)(\.\d{0,1})?)|99|99.0)$/, message: '抵扣比例请输入1-99之间的数字,最多一位小数', trigger: 'blur' }],
