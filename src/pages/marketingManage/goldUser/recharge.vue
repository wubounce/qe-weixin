  ...
  data() {
    return {
      ...
      rechargeFormRules: {
        ...
        cashValue: [{ required: true, message: '请填写充值金额', trigger: 'blur' }, { pattern: /^(([1-9]|([1-9][0-9]{1,2}([0-8])?)|([1-9][0-8]{1,2}([0-9])?))(\.\d{0,2})?|0\.\d{0,2}|9999|9999.0|9999.00)$/, message: '充值金额请输入0~9999之间数字', trigger: 'blur' }],
